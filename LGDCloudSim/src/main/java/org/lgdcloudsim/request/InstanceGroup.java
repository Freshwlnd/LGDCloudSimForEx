...
public interface InstanceGroup extends RequestEntity {
    ...
    /**
     * Get the network limitation of the instance group.
     * @return the number of network limitations of the instance group.
     */
    int getEdgeNumLinked();
    ...
    /**
     * Get the interSchedulePresolveTime of the instance group.
     * @return the interSchedulePresolveTime of the instance group.
     */
    double getInterSchedulePresolveTime();

    /**
     * Set the interSchedulePresolveTime of the instance group.
     * @param interSchedulePresolveTime the interSchedulePresolveTime of the instance group.
     */
    InstanceGroup setInterSchedulePresolveTime(double interSchedulePresolveTime);
}
