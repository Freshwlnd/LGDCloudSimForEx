...
public interface InstanceGroupGraph extends RequestEntity{
    ...
    /**
     * Get the number of edges linked to the instance group.
     * @param instanceGroup the instance group to be checked.
     * @return the number of edges linked to the instance group.
     */
    int getEdgeNumLinked(InstanceGroup instanceGroup);
}
