...
public class InstanceGroupSimple implements InstanceGroup {
    ...
    @Getter
    double interSchedulePresolveTime;
    ...
    @Override
    public int getEdgeNumLinked() {
        return getUserRequest().getInstanceGroupGraph().getEdgeNumLinked(this);
    }
    ...
    @Override
    public InstanceGroup setInterSchedulePresolveTime(double interSchedulePresolveTime) {
        this.interSchedulePresolveTime = interSchedulePresolveTime;
        return this;
    }
}
