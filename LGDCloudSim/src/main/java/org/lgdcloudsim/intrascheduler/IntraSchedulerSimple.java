...
public class IntraSchedulerSimple implements IntraScheduler {
    ...
    public IntraSchedulerSimple(int id, int firstPartitionId, int partitionNum) {
        instanceQueue = new InstanceQueueFifo(this.datacenter);
        retryInstanceQueue = new InstanceQueueFifo(this.datacenter);
    ...
    public void setDatacenter(Datacenter datacenter) {
        ...
        this.instanceQueue.setDatacenter(datacenter);
        this.retryInstanceQueue.setDatacenter(datacenter);
    }
}
