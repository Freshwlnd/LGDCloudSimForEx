...
public class SqlRecordDetailScheduleTime implements SqlRecord {
    ...
    /**
     * Construct a SqlRecordSimple with the given database name and directory suffix.
     *
     * @param dbName the name of the SQLite database
     * @param dirSuf the suffix of the directory
     */
    public SqlRecordDetailScheduleTime(String dbName, String dirSuf) {
        this("./RecordDb/"+dirSuf, dbName, "userRequest", "instanceGroup", "instanceGroupGraph", "instance", "datacenter", "dcNetwork");
    }
    ...
    private void addEdgeToStatement(InstanceGroupEdge instanceGroupEdge, double clock) throws SQLException {
        if (instanceGroupEdge.getSrc().getReceiveDatacenter() != Datacenter.NULL && !instanceGroupEdge.getSrc().getReceiveDatacenter().isFailureCluster() && instanceGroupEdge.getDst().getReceiveDatacenter() != Datacenter.NULL && !instanceGroupEdge.getDst().getReceiveDatacenter().isFailureCluster()) {
