...
public class CollaborationManagerSimple implements CollaborationManager {
    ...
    /**
     * The map of the collaboration id and the center schedulers presolve busy status.
     * The key is the collaboration id, and the key of the sub map is the center scheduler id, and the value is the busy status of the center scheduler in the presolve stage.
     */
    private Map<Integer, Map<Integer, Boolean>> centerSchedulersPresolveBusyMap = new HashMap<>();

    /**
     * The map of the collaboration id and the center schedulers schedule busy status.
     * The key is the collaboration id, and the key of the sub map is the center scheduler id, and the value is the busy status of the center scheduler in the schedule stage.
     */
    private Map<Integer, Map<Integer, Boolean>> centerSchedulersScheduleBusyMap = new HashMap<>();
    ...
    public List<Datacenter> getDatacenters(int collaborationId) {
        ...
        Collections.sort(datacenterList, Comparator.comparingInt(Datacenter::getId));
    ...
    public CollaborationManager addCenterSchedulers(int collaborationId, List<InterScheduler> centerSchedulers) {
        ...
        centerSchedulersPresolveBusyMap.put(collaborationId, new HashMap<>());
        centerSchedulersScheduleBusyMap.put(collaborationId, new HashMap<>());
        for (InterScheduler centerScheduler : centerSchedulers) {
            ...
            centerSchedulersPresolveBusyMap.get(collaborationId).put(centerScheduler.getId(), false);
            centerSchedulersScheduleBusyMap.get(collaborationId).put(centerScheduler.getId(), false);
        }
        return this;
    }
    ...
    @Override
    public Map<Integer, Boolean> getCenterSchedulersPresolveBusyMap(int collaborationId) {
        return centerSchedulersPresolveBusyMap.get(collaborationId);
    }

    @Override
    public Map<Integer, Boolean> getCenterSchedulersScheduleBusyMap(int collaborationId) {
        return centerSchedulersScheduleBusyMap.get(collaborationId);
    }
