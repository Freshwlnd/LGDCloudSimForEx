...
public interface CollaborationManager {
    ...
    /**
     * Get the map of the collaboration id and the center scheduler presolve busy status.
     * If the value is true, the center scheduler is busy, it can not start a new scheduling.
     * Otherwise, the center scheduler is idle.
     *
     * @return the map of the collaboration id and the center scheduler presolve busy status
     */
    Map<Integer, Boolean> getCenterSchedulersPresolveBusyMap(int collaborationId);

    /**
     * Get the map of the collaboration id and the center scheduler schedule busy status.
     * If the value is true, the center scheduler is busy, it can not start a new scheduling.
     * Otherwise, the center scheduler is idle.
     *
     * @return the map of the collaboration id and the center scheduler schedule busy status
     */
    Map<Integer, Boolean> getCenterSchedulersScheduleBusyMap(int collaborationId);
