...
public interface Datacenter extends SimEntity, DatacenterPrice {
    ...
    /**
     * Set whether the failure cluster is set.
     * If the failure cluster is set, the datacenter is a failure cluster.
     *
     * @param failureClusterFlag whether the failure cluster is set.
     * @return the datacenter.
     */
    Datacenter setFailureClusterFlag(boolean failureClusterFlag);

    /**
     * Get whether the datacenter is a failure cluster.
     **/
    boolean isFailureCluster();
