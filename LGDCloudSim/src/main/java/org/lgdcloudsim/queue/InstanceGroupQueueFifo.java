...
public class InstanceGroupQueueFifo implements InstanceGroupQueue {
    ...
    @Getter
    @Setter
    protected boolean checkOutdatedFlag = false;
    ...
    /** 
     * The time of the last sorting before adding instance groups to the queue.
     * FIFO method does not need to sort, so sortTime is 0.0
     */
    @Getter
    @Setter
    public double sortTime = 0.0;
