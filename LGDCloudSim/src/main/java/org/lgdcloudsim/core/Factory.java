...
public interface Factory {
    ...
    /**
     * Get the {@link SqlRecord} by the type name, the database name and the directory suffix.
     * @param type the type name of the sql record.
     * @param dbName the database name.
     * @param dirSuf the directory suffix.
     * @return the sql record.
     */
    SqlRecord getSqlRecord(String type, String dbName, String dirSuf);
}
